"""Settings panel for Sendible Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__sendible_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=sendible_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_sendible"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Sendible Settings & Accounts", level=2),
