...
async def connect_sendible(params: ConnectParams, ctx) -> ActionResult[ConnectionRecord]:
...
async def disconnect_sendible(params: ConnectionIdParams, ctx) -> ActionResult[DeleteResult]:
    conns = await _load_connections(ctx)
